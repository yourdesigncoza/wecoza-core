   ...
   <div class="container container-md classes-form ps-0">
      ...
      <div class="mb-4 mt-3">
         ...
         <div id="per-day-time-controls" class="d-none mt-3">
            ...
            <!-- Hidden template for day time section (multi-interval support) -->
...
<?php echo wecoza_component('form-help-panel', ['form_key' => 'create-class', 'offcanvas_id' => 'createClassHelp']); ?>
