# Requirements Archive: v6.0 Agent Attendance Capture
...
- [x] **ATT-01**: Agent can capture per-learner hours present for a scheduled class session
- [x] **ATT-02**: Hours_trained auto-populated from class schedule (same for all learners in a session)
- [x] **ATT-03**: Hours present defaults to full scheduled hours; agent adjusts down for late/absent learners
- [x] **ATT-04**: Hours absent auto-calculated as hours_trained minus hours_present
...
| ATT-01 | Phase 51 | Complete |
| ATT-02 | Phase 51 | Complete |
| ATT-03 | Phase 51 | Complete |
| ATT-04 | Phase 51 | Complete |
...
*Last updated: 2026-02-24 — all 25/25 requirements complete, milestone shipped*
