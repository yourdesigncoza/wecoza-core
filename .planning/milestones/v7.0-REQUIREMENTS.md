# Requirements Archive: v7.0 Agent Attendance Access
...
- [x] **AGT-07**: Agent is redirected away from WP admin and other WeCoza pages — can only access attendance page
- [x] **AGT-08**: Agent login shows attendance page directly (no WP dashboard)
...
| AGT-07 | Phase 55 | Complete |
| AGT-08 | Phase 55 | Complete |
