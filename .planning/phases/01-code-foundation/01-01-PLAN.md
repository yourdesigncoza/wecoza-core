...
<task type="auto">
  ...
  <verify>
    ...
    - `php -r "require 'vendor/autoload.php'; echo 'Autoloader OK';"` confirms autoloader works at runtime
  </verify>
  <done>
    Directory structure exists at src/Events/ with Models/, Repositories/, Services/, Controllers/, Shortcodes/, Support/, CLI/, Admin/ subdirectories. Composer.json includes WeCoza\Events\ PSR-4 mapping. Autoloader runtime test passes.
  </done>
</task>
