...
4. `php -l src/Clients/Controllers/LocationsController.php` - no syntax errors
5. `php -l src/Clients/Models/LocationsModel.php` - no syntax errors
6. `php -l views/clients/components/location-capture-form.view.php` - no syntax errors
  </verify>
  <done>
