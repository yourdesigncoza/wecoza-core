...
6. Grep for duplicate detection logic in PHP script — should be present (case-insensitive match on street_address + suburb + town + province + postal_code before INSERT)
  </verify>
  <done>
