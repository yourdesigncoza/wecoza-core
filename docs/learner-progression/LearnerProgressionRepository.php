...
class LearnerProgressionRepository {
    private $db;
    ...
    public function findCurrentForLearner(int $learnerId): ?array {
        ...
        try {
            ...
            error_log("Error in findCurrentForLearner: " . $e->getMessage());
            return null;
        }
    }
    ...
    public function findAllForLearner(int $learnerId): array {
        ...
        try {
            ...
            error_log("Error in findAllForLearner: " . $e->getMessage());
            return [];
        }
    }
    ...
    public function findHistoryForLearner(int $learnerId): array {
        ...
        try {
            ...
            error_log("Error in findHistoryForLearner: " . $e->getMessage());
            return [];
        }
    }
    ...
    public function findByClass(int $classId, ?string $status = null): array {
        ...
        try {
            ...
            error_log("Error in findByClass: " . $e->getMessage());
            return [];
        }
    }
    ...
    public function findByProduct(int $productId, ?string $status = null): array {
        ...
        try {
            ...
            error_log("Error in findByProduct: " . $e->getMessage());
            return [];
        }
    }
    ...
    public function logHours(array $data): bool {
        ...
        $sql = "INSERT INTO learner_hours_log ($columnList, created_at) VALUES ($placeholders, :created_at)";

        try {
            $stmt = $this->db->query($sql, $filteredData);
            return true;
        } catch (\Exception $e) {
            error_log("Error in logHours: " . $e->getMessage());
            return false;
        }
    }
    ...
    public function getHoursLog(int $trackingId): array {
        ...
        try {
            ...
            error_log("Error in getHoursLog: " . $e->getMessage());
            return [];
        }
    }
    ...
    public function getHoursLogForLearner(int $learnerId, ?string $startDate = null, ?string $endDate = null): array {
        ...
        try {
            ...
            error_log("Error in getHoursLogForLearner: " . $e->getMessage());
            return [];
        }
    }

    /**
     * Calculate total hours from schedule for a learner/product
     */
    public function calculateHoursFromSchedule(int $learnerId, int $productId): float {
        // This will need to be implemented based on how schedule data is stored
        // For now, return 0 - to be implemented when schedule structure is known
        $sql = "
            SELECT COALESCE(SUM(hours_trained), 0) as total
        ...
        try {
            ...
            error_log("Error in calculateHoursFromSchedule: " . $e->getMessage());
            return 0;
        }
    }

    /**
     * Calculate total hours from attendance for a learner/product
     */
    public function calculateHoursFromAttendance(int $learnerId, int $productId): float {
        $sql = "
            SELECT COALESCE(SUM(hours_present), 0) as total
            FROM learner_hours_log
            WHERE learner_id = :learner_id
            AND product_id = :product_id
        ...
        try {
            ...
            error_log("Error in calculateHoursFromAttendance: " . $e->getMessage());
            return 0;
        }
    }
    ...
    public function getMonthlyProgressions(int $year, int $month): array {
        ...
        try {
            ...
            error_log("Error in getMonthlyProgressions: " . $e->getMessage());
            return [];
        }
    }

    /**
     * Get all progressions with filters (for admin panel)
     */
    ...
    public function savePortfolioFile(int $trackingId, array $fileData): ?int {
        ...
        try {
            ...
            error_log("Error in savePortfolioFile: " . $e->getMessage());
            return null;
        }
    }
    ...
    public function getPortfolioFiles(int $trackingId): array {
        ...
        try {
            ...
            error_log("Error in getPortfolioFiles: " . $e->getMessage());
            return [];
        }
    }
}
