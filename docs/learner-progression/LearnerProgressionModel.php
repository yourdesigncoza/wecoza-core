...
use WeCoza\Core\Models\BaseModel;
...
class LearnerProgressionModel extends BaseModel {
    ...
    private static ?\WeCoza\Repositories\LearnerProgressionRepository $repository = null;

    /**
     * Get repository instance (lazy loaded)
     */
    private static function getRepository(): \WeCoza\Repositories\LearnerProgressionRepository {
        if (self::$repository === null) {
            require_once WECOZA_LEARNERS_PLUGIN_DIR . 'repositories/LearnerProgressionRepository.php';
            self::$repository = new \WeCoza\Repositories\LearnerProgressionRepository();
        }
     ...
     */
    public static function getById(int $trackingId): ?self {
     ...
     */
    public static function getCurrentForLearner(int $learnerId): ?self {
    ...
    public function save(): bool {
        // Recalculate absent hours before saving
    ...
    // =========================================================================
    public function setLearnerId(int $learnerId): self { $this->learnerId = $learnerId; return $this; }
    ...
    public function setHoursTrained(float $hours): self { $this->hoursTrained = $hours; return $this; }
    public function setHoursPresent(float $hours): self { $this->hoursPresent = $hours; return $this; }
